...
class Robot:
    ...
    def __init__(self,scene:Scene,position=(0,0)):
        ...
        self._base.setColor((231, 255, 13))
        self._m1=DCMotor("m1",scene.Space(),self._base.Body(),(0.0,50.0),1,500)
        self._m2=DCMotor("m2",scene.Space(),self._base.Body(),(0.0,-50.0),1,500)
        ...
        self._m1.set_power(34)
        self._m2.set_power(35)
